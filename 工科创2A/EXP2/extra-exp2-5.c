...
//讨论5
//单跑马灯，通过sw1来控制跑马频率
//题目要求：用USR_SW1 控制跑马灯的频率
//         按第 1 下，间隔为 1S
//         按第 2 下，间隔为 2S
//         按第 3 下，间隔为 0.2S
//         按第 4 下，回到上电初始状态，间隔 0.5S
//         以 4 为模，循环往复
//核心思路，设置变量count，利用count调节time控制频率
  ...
  ui32SysClock = SysCtlClockFreqSet((SYSCTL_XTAL_16MHZ |SYSCTL_OSC_INT |SYSCTL_USE_OSC), 16000000);		
   ...
   IntMasterEnable();		
	  ...
	  while(!read_key_value)
    {
		...
		switch (count)
		{
				case 0 : Time = 500;break;  //初始状态，间隔0.5s
				case 1 : Time = 1000;break;   //间隔1s
				case 2 : Time = 2000;break;   //间隔2s
				case 3 : Time = 200;break;    //间隔0.2s
				case 4:  count=0;             //循环
		}
